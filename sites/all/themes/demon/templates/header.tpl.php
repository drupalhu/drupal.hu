<div id="page-wrapper"><div id="page">
  ...
  <div id="header" class="<?php print $secondary_menu ? 'with-secondary-menu ': 'without-secondary-menu '; ?>container-24"><div class="section clearfix">
    ...
    <?php if ($logo): ?>
      <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo" class="grid-6">
  ...
  <?php if ($messages): ?>
    <div id="messages" class="container-24"><div class="section clearfix">
      <?php print $messages; ?>
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix container-24">
