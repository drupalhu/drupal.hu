...
namespace DrupalHu\DrupalHu\Tests\FunctionalJavascript\Note;

use DrupalHu\DrupalHu\Tests\FunctionalJavascript\NodeAccessTestBase;

class NoteNodeAccessTest extends NodeAccessTestBase {
    ...
    foreach ($userRoles as $userRole) {
      $cases += [
        ...
        "o:1 s:0 r:$userRole" => [
          [
            'statusCode' => [
              // @todo Should be 403, but the "view own unpublished content" permission
              // also applies to this one.
              'view' => $userRole === 'anonymous' ? 403 : 404,
              'edit' => 403,
              'delete' => 403,
            ],
          ],
