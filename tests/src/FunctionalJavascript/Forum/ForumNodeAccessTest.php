...
class ForumNodeAccessTest extends NodeAccessTestBase {

  protected string $nodeTypeId = 'forum';
  ...
  public function casesNodeAccess(): array {
    ...
    $fieldTaxonomyForums = [
      // Forum topic category taxonomy term ID.
      ['target_id' => 5],
    ];
    ...
    $authenticated = [
      'o:0 s:0 r:authenticated' => [
        ...
        [
          'status' => 0,
          'taxonomy_forums' => $fieldTaxonomyForums,
        ],
        [
          'roles' => [
            ['target_id' => 'authenticated'],
